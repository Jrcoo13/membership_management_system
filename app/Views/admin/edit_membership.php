	...
	<div class="main-wrapper">
			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="active"> <a href="#"><i class="far fa-money-bill-alt"></i> <span> Membership Plans </span></a></li>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form action="<?= base_url('/admin/update_membership/'.$membership['id']) ?>" method="POST">
							<div class="row formtype">
								<div class="col-md-4">
									<div class="form-group">
										<label for="membership_name">Membership Name</label>
										<input class="form-control" type="text" name="membership_name" id="membership_name" value="<?= $membership['membership_name'] ?>">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label for="amount">Amount</label>
										<input class="form-control" type="tel" name="amount" id="amount" value="<?= $membership['amount'] ?>">
									</div>
								</div>
								<div class="col-md-4">
                                    <div class="form-group">
                                        <label for="partial_payment">Course</label>
                                        <select class="form-control" id="partial_payment" name="partial_payment" value="<?= $membership['partial_payment'] ?>">
