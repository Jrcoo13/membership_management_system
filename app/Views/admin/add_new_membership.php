	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form action="<?= base_url('/admin/add_membership') ?>" method="POST" class="row g-3 needs-validation" novalidate>
							<div class="row formtype">
								<div class="col-md-4">
									<div class="form-group">
										<label for="membership_name">Membership Name</label>
										<input class="form-control" type="text" name="membership_name" id="membership_name" required>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select class="form-control" name="partial_payment" id="partial_payment" required>
