                    ...
                    <div class="row">
                        <div class="col-sm-12 mt-5">
                            <div class="mt-3">
                                ...
                                <h4 class="page-title float-left">Membership Plans</h4><a href="<?= base_url('/admin/add_new_membership') ?>" class="btn btn-primary btn-sm float-right">Add New Membership</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <?php foreach ($memberships as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="<?= base_url('/admin/edit_membership/' . $row['id']); ?>" class="btn btn-light btn-sm text-primary"><i class="fa-regular fa-pen-to-square"></i></a>
                                                            <button class="btn btn-light btn-sm text-danger" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-id="<?= $row['id'] ?>">
