            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="list-divider"></li>
                        <li class="active"> <a href="<?= base_url('/admin/pending_payment') ?>"><i class="fa-solid fa-user-clock"></i> <span> Pending Payment </span></a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-12 mt-5">
                            <div class="mt-3">
                                ...
                                <h4 class="page-title float-left">Pending Payment</h4>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card card-table flex-fill">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-hover table-center display responsive nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Student ID</th>
                                                <th>Student Name</th>
                                        ...
                                        <tbody>
                                            <?php if (empty($pending_payment)): ?>
                                                <tr>
                                                    <td colspan="6" class="text-center">No pending transaction yet</td>
                                                </tr>
                                            <?php else: ?>
                                                <?php foreach ($pending_payment as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <form action="<?= base_url('approve_request/' . $row['id']) ?>" method="POST" class="d-inline-block">
                                                                <button type="submit" class="btn btn-light btn-sm border-0 text-success bg-success-light">
                                                                    Approve
                                                                </button>
                                                            </form>
                                                            <form action="<?= base_url('reject_request/' . $row['id']) ?>" method="POST" class="d-inline-block">
                                                                <button type="submit" class="btn btn-light btn-sm border-0 text-danger bg-danger-light">
                                                                    Reject
                                                                    </butto>
                                                            </form>
                                                        </td>
